...
class ComplexDetailAddPlace extends StatefulWidget {
  static const routeName = '/complexDetailAddPlace';

  @override
  _ComplexDetailAddPlaceState createState() => _ComplexDetailAddPlaceState();
}

enum GenderSelection { male, female }

class _ComplexDetailAddPlaceState extends State<ComplexDetailAddPlace> {
...
//    complex_id = ModalRoute.of(context).settings.arguments as int;
  ...
  void didChangeDependencies() async {
    if (_isInit) {
      ...
      complex_id = arguments != null ? arguments['complexId'] : 0;
  ...
  Future<void> addPlace(
    ...
    await Provider.of<Complexes>(context, listen: false).createPlace(complex_id,
        name, excerpt, about, price, fields, facilities, place_type_id);
