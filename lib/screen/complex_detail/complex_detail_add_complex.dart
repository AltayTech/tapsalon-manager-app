...
class ComplexDetailAddComplex extends StatefulWidget {
  static const routeName = '/complexDetailAddComplex';

  @override
  _ComplexDetailAddComplexState createState() =>
      _ComplexDetailAddComplexState();
}

enum GenderSelection { male, female }

class _ComplexDetailAddComplexState extends State<ComplexDetailAddComplex> {
  ...
  Future<void> addComplex(
    ...
    await Provider.of<Complexes>(context, listen: false).createComplex(ostan_id,
        city_id, region_id, name, excerpt, about, address, phone, mobile);
